Agro 4.0: Modelado y Simulación de Cultivos Regionales 🚀🌱
Este repositorio contiene los modelos numéricos y simulaciones desarrollados para mi tesis de grado en Ingeniería. El proyecto aplica técnicas de Inteligencia Artificial, Análisis de Eficiencia (DEA) y Sistemas de Ecuaciones Diferenciales para optimizar la producción de Limón, Poroto y Maíz en la región de las Yungas.
...
2. Eficiencia Productiva (Poroto) - modelo_poroto_dea.py
Uso de Data Envelopment Analysis (DEA) y regresiones polinomiales para identificar la frontera de eficiencia en 87 unidades de toma de decisión (DMUs).
...
3. Dinámica de Suelo (Maíz Pisingallo) - modelo_maiz_edo.py
...
Ingeniero Martín Enrique Méndez, UNIVERSIDAD CATÓLICA DE SANTIAGO DEL ESTERO - UCSE DASS